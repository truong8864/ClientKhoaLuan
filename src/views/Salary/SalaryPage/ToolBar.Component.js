...
const ToolBar = (props) => {
  ...
  const { setConfimDelete, RowsSelected, onSearch, show, data, fields } = props;
    ...
    <Toolbar variant="dense" disableGutters className={classes.root}>
      <div className={classes.left}>
        ...
        <Typography variant="h6" component="h2">
          {RowsSelected
            ? `Kì công ${RowsSelected.KiCong} Nhân viên ${RowsSelected.ProfileName}`
            : null}
        </Typography>
      </div>
      ...
      <div className={classes.right}>
        <div>
          <IconButton
            disabled={RowsSelected ? false : true}
            onClick={() => show(true)}
          >
