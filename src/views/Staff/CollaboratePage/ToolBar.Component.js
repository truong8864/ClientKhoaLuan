...
import {
  DeleteHreCollaboratesApi,
  UpdaHreCollaboratesApi,
} from "../../../callAPI/Hre_Collaborates.api";
...
const ToolBar = (props) => {
  ...
  const GoAccept = () => {
    UpdaHreCollaboratesApi(
      RowSelected._id,
      qs.stringify({ Accept: "Đã duyệt" })
    );
  };
  const GoUnAccept = () => {
    UpdaHreCollaboratesApi(
      RowSelected._id,
      qs.stringify({ Accept: "Chưa duyệt" })
    );
  };
          ...
          <div>
            {RowSelected.Accept === "Chưa duyệt" ? (
              <Button
                onClick={GoAccept}
                type="submit"
                disabled={RowSelected.Accept === "Chưa duyệt" ? false : true}
                color="primary"
              >
                <Tooltip title="Duyệt">
            ...
            <IconButton
              ...
              disabled={
                RowSelected.Status === "Chuẩn bị công tác" ? true : false
              }
            >
            ...
            <IconButton
              ...
              disabled={
                RowSelected.Status === "Chuẩn bị công tác" ? false : true
              }
            >
            ...
            <IconButton
              disabled={
                JSON.stringify(RowSelected) === JSON.stringify({})
                  ? true
                  : false
              }
              onClick={goDetail}
